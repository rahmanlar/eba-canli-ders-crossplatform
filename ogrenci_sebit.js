if (window.location.toString().includes("liveMiddleware")) {
        ...
        if (resp.liveLessonInfo.studyTime.registrantJoinUrl) {
          ...
          $.ajax({
            ...
            success : function(resp2) {
              ...
              $.ajax({
                url : "https://cagriari.com/eba_nonceproxy_sebit.php?nonce=" +
                          resp2.meeting.token,
  ...
  $.ajax({
    url :
        "https://uygulama.sebitvcloud.com/VCloudFrontEndService//studytime/getstudentstudytime",
    method : "POST",
    headers : {
      "Content-Type" : "application/x-www-form-urlencoded",
      "Accept" : "json"
    ...
    success : function(resp) {
      ...
      $.ajax({
        url :
            "https://uygulama.sebitvcloud.com/VCloudFrontEndService//livelesson/instudytime/start",
        method : "POST",
        headers : {
          "Content-Type" : "application/x-www-form-urlencoded",
          "Accept" : "json"
